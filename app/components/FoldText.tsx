...
export default function FoldText({
  ...
  const rootStyle: CSSProperties = {
    ...(fontSize !== "inherit" ? { "--fold-text-font-size": typeof fontSize === "number" ? `${fontSize}px` : fontSize } : {}),
    ...(fontWeight !== "inherit" ? { "--fold-text-font-weight": fontWeight } : {}),
    ...(color !== "inherit" ? { "--fold-text-color": color } : {}),
    ...style,
  } as CSSProperties;
